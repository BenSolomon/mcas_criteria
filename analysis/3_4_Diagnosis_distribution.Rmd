...
df_claude3_haiku_t1_0 <- read_csv(here("data/processed_diagnoses/diagnoses_claude3_haiku_t1-0.csv.gz"))
df_claude3_haiku_t0_1 <- read_csv(here("data/processed_diagnoses/diagnoses_claude3_haiku_t0-1.csv.gz"))
df_claude3_opus_t1_0 <- read_csv(here("data/processed_diagnoses/diagnoses_claude3_opus_t1-0.csv.gz"))
df_gemini_t1_0 <- read_csv(here("data/processed_diagnoses/diagnoses_gemini_t1-0.csv.gz"))
```
# Rank abundance
```{r}
...
rank_abundance_plot(df_claude3_haiku_t1_0)+ggtitle("Claude3 Haiku t1.0")
rank_abundance_plot(df_claude3_haiku_t0_1)+ggtitle("Claude3 Haiku t0.1")
rank_abundance_plot(df_claude3_opus_t1_0)+ggtitle("Claude3 Opus t1.0")
rank_abundance_plot(df_gemini_t1_0)+ggtitle("Gemini t1.0")
```

```{r}
bind_rows(
  rank_abundance_plot(df_gpt3)$data,
  rank_abundance_plot(df_gpt4)$data,
  # rank_abundance_plot(df_gpt4_icd)$data,
  rank_abundance_plot(df_claude3_haiku_t1_0)$data,
  rank_abundance_plot(df_claude3_opus_t1_0)$data,
  rank_abundance_plot(df_gemini_t1_0)$data
) %>% 
...
top_diagnosis_plot(df_claude3_haiku_t0_1, n_diag = n_diag)+ggtitle("Claude3 Haiku t0.1")
top_diagnosis_plot(df_claude3_haiku_t1_0, n_diag = n_diag)+ggtitle("Claude3 Haiku t1.0")
top_diagnosis_plot(df_claude3_opus_t1_0, n_diag = n_diag)+ggtitle("Claude3 Opus t1.0")
top_diagnosis_plot(df_gemini_t1_0, n_diag = n_diag)+ggtitle("Gemini t1.0")
```
...
cumulative_frequency_plot(df_claude3_haiku_t1_0)+ggtitle("Claude3 Haiku")
cumulative_frequency_plot(df_claude3_opus_t1_0)+ggtitle("Claude3 Haiku")
cumulative_frequency_plot(df_gemini_t1_0)+ggtitle("Gemini t1.0")
```
```{r, fig.width=3, fig.height=3.5}
bind_rows(
  cumulative_frequency_plot(df_gpt3)$data,
  cumulative_frequency_plot(df_gpt4)$data,
  # cumulative_frequency_plot(df_gpt4_icd)$data,
  cumulative_frequency_plot(df_claude3_haiku_t1_0)$data,
  cumulative_frequency_plot(df_claude3_opus_t1_0)$data,
  cumulative_frequency_plot(df_gemini_t1_0)$data
) %>% 
...
calculate_diversity_ci(df_gpt3) %>% plot_diversity_ci() + ggtitle("GPT3")
calculate_diversity_ci(df_gpt4) %>% plot_diversity_ci() + ggtitle("GPT4")
calculate_diversity_ci(df_gpt4_icd) %>% plot_diversity_ci() + ggtitle("GPT4 ICD")
calculate_diversity_ci(df_claude3_haiku_t0_1) %>% plot_diversity_ci() + ggtitle("Claude3 Haiku t0.1")
calculate_diversity_ci(df_claude3_haiku_t1_0) %>% plot_diversity_ci() + ggtitle("Claude3 Haiku t1.0")
calculate_diversity_ci(df_gemini_t1_0) %>% plot_diversity_ci() + ggtitle("Gemini t1.0")
...
tibble(model = c("ChatGPT3.5", "ChatGPT4", "Claude3 Haiku", "Claude3 Opus", "Gemini Pro 1.0"),
       data = list(df_gpt3, df_gpt4, df_claude3_haiku_t1_0, df_claude3_opus_t1_0, df_gemini_t1_0)) %>% 
