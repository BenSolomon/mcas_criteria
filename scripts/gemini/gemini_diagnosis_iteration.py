...
def gemini_wrapper(i, criteria, symptoms, gemini_version="gemini-1.0-pro", temp = 1.0, output_query=False):
    inputs=locals()
...
def gemini_pipeline(iteration_path, output_dir, batch_size = 1000, gemini_version = "gemini-1.0-pro", temp = 1.0, maximum_batches = None):
